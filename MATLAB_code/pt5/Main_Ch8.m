...
%     [SigxOL,SigzOL, SigxCL, SigzCL, An, Bn, Gn, Dx_new, Dun, Dwn,L]= cont_time_EDORCH8();
...
% Linearize system around SS values And calulate OPEN LOOP cov Matrix 
    [SigxdOL,SigzdOL, SigxdCL, SigzdCL, Ad_new, Bd_new, Gd_new, Dx_new, Du_new, Dwn,L]= disc_time_EDORCH8;
...
title('Discrete Time Ellipse and EDOR')
